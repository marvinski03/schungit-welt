...
?>
		...
		<?php wp_footer(); ?>
		<script src='/wp-content/themes/Avada-Child-Theme/js/jsdirect.js'></script>

		<div id="shopauskunft-side">
			<script src='/wp-content/themes/Avada-Child-Theme/js/custom-widget.js'></script>
		</div>
